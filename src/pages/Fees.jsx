...
export default function Fees() {
  ...
  return (
    <LoginRequired allowedRoles={['admin', 'principal', 'teacher', 'staff', 'accountant']} pageName="Fees">
      <div className="min-h-screen w-full bg-slate-50 dark:bg-gray-900 flex flex-col">
        <PageHeader
          title="Fees"
        ...
        <div className={`flex-1 px-3 sm:px-4 lg:px-8 py-4 ${isAccountant ? 'accountant-fees-view' : ''}`}>
