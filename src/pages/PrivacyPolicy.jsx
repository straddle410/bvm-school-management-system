       ...
       <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 dark:border-gray-700 p-6 md:p-10">
          ...
          <Section title="1. Information We Collect">
            ...
            <DataTable rows={[
              ...
              ['Staff Leave Records', 'Leave requests (from/to dates, type, reason), pay type (Paid/Unpaid), approval status, admin remarks'],
              ['Staff Salary Data', 'Monthly salary configuration, attendance-based earnings, leave deductions, payment records'],
