...
import {
  ...
  Ticket, Calendar, TrendingUp, FileText, Award, BarChart3, AlertCircle, Image, User as UserIcon, UserX
} from 'lucide-react';
...
export default function More() {
  ...
  const supportItems = [
    ...
    { label: 'About App', sub: 'Version 1.0.0', icon: Info, color: '#78909c', bg: '#eceff1' },
  ];
