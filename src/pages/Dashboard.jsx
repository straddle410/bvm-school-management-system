    ...
    <div className="min-h-screen bg-[#f0f4ff] flex flex-col w-full overflow-x-hidden relative">
      ...
      <header className="sticky top-0 z-50 w-full">
        <div className="bg-gradient-to-r from-[#1a237e] via-[#283593] to-[#3949ab] px-3 sm:px-4 pt-4 pb-5 shadow-lg">
          ...
          <div className="flex items-center gap-3 -mx-3 px-3 py-2 rounded-xl">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-white font-bold text-base leading-tight">Welcome Back</h2>
              <p className="text-blue-200 text-xs capitalize">{user?.role || 'Visitor'}</p>
            </div>
          </div>
        </div>
      </header>
