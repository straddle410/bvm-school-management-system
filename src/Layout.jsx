...
export default function Layout({ children, currentPageName }) {
  ...
  const STUDENT_ALLOWED_PAGES = ['StudentAttendance', 'StudentMarks', 'StudentDiary', 'StudentNotices', 'StudentTimetable', 'StudentHomework', 'StudentMessaging', 'Quiz', 'Results', 'Notices', 'Gallery', 'Calendar', 'Diary', 'More'];
