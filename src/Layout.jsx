...
const NO_LAYOUT_PAGES = ['Index', 'index', 'Home', 'PublicAdmission', 'StaffLogin', 'StudentLogin', 'StudentDashboard', 'StudentHomework', 'StudentMessaging', 'UserProfile', 'PrintReceiptA5', 'TermsAndConditions'];
