...
const NO_LAYOUT_PAGES = ['Home', 'PublicAdmission', 'StaffLogin', 'StudentLogin', 'StudentDashboard', 'StudentHomework', 'StudentHallTicketView', 'StudentMessaging', 'UserProfile', 'PrintReceiptA5'];
