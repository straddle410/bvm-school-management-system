...
export default function AcademicYearSelector() {
  ...
  // Non-admins just see the current year (read-only)
  if (!isAdmin) {
    return (
      <div className="flex items-center gap-1 text-xs text-blue-200 font-medium px-2 py-1.5 bg-white/10 rounded-lg">
