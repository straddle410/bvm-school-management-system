...
export function printHallTickets(tickets, timetableMap, schoolProfile, examTypesMap) {
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* BADGE */
    .badge-row { background: #e8e8e8; color: #111; text-align: center; font-size: 10px; font-weight: 700; padding: 2px 0; letter-spacing: 0.05em; border-bottom: 1.25px solid #333; -webkit-print-color-adjust: exact; print-color-adjust: exact; }

    /* BODY */
    .body-row { display: flex; flex: 1; min-height: 0; }

    /* STUDENT COL */
    .student-col { display: flex; flex-direction: column; padding: 5px 6px; border-right: 1.25px solid #333; width: 52mm; flex-shrink: 0; gap: 5px; }
    .photo-wrap { display: flex; justify-content: center; }
    .photo { width: 60px; height: 75px; object-fit: cover; border: 1.25px solid #333; border-radius: 3px; }
    .no-photo { width: 60px; height: 75px; background: #eee; border: 1.25px solid #333; border-radius: 3px; display: flex; align-items: center; justify-content: center; font-size: 8px; color: #999; text-align: center; }
    ...
    /* FOOTER */
    .footer-row { display: flex; align-items: flex-end; gap: 8px; padding: 4px 6px 5px; border-top: 1.25px solid #333; background: #fafafa; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    .instr { flex: 1; }
    ...
    .sig-line { border-top: 1.25px solid #333; width: 80px; margin: 0 auto 2px; }
