  ...
  return (
    <div className={`rounded-2xl shadow-sm hover:shadow-md transition-shadow cursor-pointer group ${isDeleted ? 'bg-red-50 border border-red-200' : 'bg-white'}`}>
      ...
      {/* Desktop table row layout */}
       <div className="hidden sm:flex w-full items-center gap-4 px-4 py-3 group-hover:opacity-90">
         <button onClick={handleViewProfile} className="flex-1 text-left flex items-center gap-4 min-w-0">
