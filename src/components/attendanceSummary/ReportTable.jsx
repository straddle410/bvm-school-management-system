          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-slate-50 dark:bg-gray-700">
                <th onClick={() => handleHeaderClick('name')} className="px-4 py-3 text-left font-semibold text-slate-700 dark:text-gray-200 cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors group">
                  <div className="flex items-center gap-2">
                    Student Name
                    <ArrowUpDown className="h-4 w-4 text-slate-400 opacity-0 group-hover:opacity-100" />
                  </div>
                </th>
                <th onClick={() => handleHeaderClick('rollNo')} className="px-4 py-3 text-center font-semibold text-slate-700 dark:text-gray-200 cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors group">
                  <div className="flex items-center justify-center gap-2">
                    Roll No
                    <ArrowUpDown className="h-4 w-4 text-slate-400 opacity-0 group-hover:opacity-100" />
                  </div>
                </th>
                <th onClick={() => handleHeaderClick('class')} className="px-4 py-3 text-center font-semibold text-slate-700 dark:text-gray-200 cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors group">
                  <div className="flex items-center justify-center gap-2">
                    Class
                    <ArrowUpDown className="h-4 w-4 text-slate-400 opacity-0 group-hover:opacity-100" />
                  </div>
                </th>
                <th onClick={() => handleHeaderClick('totalWorkingDays')} className="px-4 py-3 text-center font-semibold text-slate-700 dark:text-gray-200 cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors group">
                  <div className="flex items-center justify-center gap-2">
                    Working Days
                    <ArrowUpDown className="h-4 w-4 text-slate-400 opacity-0 group-hover:opacity-100" />
                  </div>
                </th>
                <th onClick={() => handleHeaderClick('totalHolidays')} className="px-4 py-3 text-center font-semibold text-slate-700 dark:text-gray-200 cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors group">
                  <div className="flex items-center justify-center gap-2">
                    Holidays
                    <ArrowUpDown className="h-4 w-4 text-slate-400 opacity-0 group-hover:opacity-100" />
                  </div>
                </th>
                <th onClick={() => handleHeaderClick('presentDays')} className="px-4 py-3 text-center font-semibold text-slate-700 dark:text-gray-200 cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors group">
                  <div className="flex items-center justify-center gap-2">
                    Present
                    <ArrowUpDown className="h-4 w-4 text-slate-400 opacity-0 group-hover:opacity-100" />
                  </div>
                </th>
                <th onClick={() => handleHeaderClick('absentDays')} className="px-4 py-3 text-center font-semibold text-slate-700 dark:text-gray-200 cursor-pointer hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors group">
                  <div className="flex items-center justify-center gap-2">
                    Absent
                    <ArrowUpDown className="h-4 w-4 text-slate-400 opacity-0 group-hover:opacity-100" />
                  </div>
